...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td><a href="src/appsscript/slide/nonValidSlideId.ts"><code>nonValidSlideId</code></a> <sup>New</sup></td>
            <td><code>Boolean</code></td>
            <td>Checks if a value is <b>not</b> a valid slide identifier.</td>
        </tr>
        <tr>
