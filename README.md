...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td><a href="src/lang/base/requireArray.ts"><code>requireArray</code></a> <sup>New</sup></td>
            <td><code>Array</code></td>
            <td>Ensures a value is an <code>Array</code>, throwing <code>IllegalArgumentException</code> otherwise.</td>
        </tr>
        <tr>
