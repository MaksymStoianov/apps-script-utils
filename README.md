...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td><a href="src/lang/string/requireVersionCompatible.ts"><code>requireVersionCompatible</code></a> <sup>New</sup></td>
            <td><code>String</code></td>
            <td>Ensures one version is at least another, throwing otherwise.</td>
        </tr>
        <tr>
