...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td><a href="src/lang/base/requireNonLength.ts"><code>requireNonLength</code></a> <sup>New</sup></td>
            <td><code>Any</code></td>
            <td>Ensures a value is <b>not</b> a valid array-like length, throwing <code>IllegalArgumentException</code> otherwise.</td>
        </tr>
        <tr>
