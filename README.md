...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td><a href="src/appsscript/slide/requireValidPresentationId.ts"><code>requireValidPresentationId</code></a> <sup>New</sup></td>
            <td><code>String</code></td>
            <td>Ensures a value is a valid presentation identifier, throwing otherwise.</td>
        </tr>
    </tbody>
</table>
