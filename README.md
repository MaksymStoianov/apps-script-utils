...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td><a href="src/lang/base/requireNumber.ts"><code>requireNumber</code></a> <sup>New</sup></td>
            <td><code>Number</code></td>
            <td>Ensures a value is a number, throwing <code>IllegalArgumentException</code> otherwise.</td>
        </tr>
        <tr>
