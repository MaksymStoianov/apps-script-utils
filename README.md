...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td><a href="src/appsscript/sheet/requireGridRangeContainedIn.ts"><code>requireGridRangeContainedIn</code></a> <sup>New</sup></td>
            <td><code>GridRange</code></td>
            <td>Ensures one grid range lies within another, throwing otherwise.</td>
        </tr>
        <tr>
