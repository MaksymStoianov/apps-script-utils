...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td><a href="src/lang/base/requireNonScalar.ts"><code>requireNonScalar</code></a> <sup>New</sup></td>
            <td><code>Any</code></td>
            <td>Ensures a value is <b>not</b> a scalar primitive, throwing <code>IllegalArgumentException</code> otherwise.</td>
        </tr>
        <tr>
