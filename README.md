...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td><a href="src/appsscript/sheet/nonCellGridRange.ts"><code>nonCellGridRange</code></a> <sup>New</sup></td>
            <td><code>Boolean</code></td>
            <td>Checks if a grid range does <b>not</b> denote exactly one cell.</td>
        </tr>
        <tr>
