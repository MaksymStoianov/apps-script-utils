...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td><a href="src/lang/base/requireNonRegExp.ts"><code>requireNonRegExp</code></a> <sup>New</sup></td>
            <td><code>Any</code></td>
            <td>Ensures a value is <b>not</b> a regular expression, throwing <code>IllegalArgumentException</code> otherwise.</td>
        </tr>
        <tr>
