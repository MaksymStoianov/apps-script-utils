...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td><a href="src/appsscript/ui/requireTextOutput.ts"><code>requireTextOutput</code></a> <sup>New</sup></td>
            <td><code>TextOutput</code></td>
            <td>Ensures a value is a <code>TextOutput</code> object, throwing otherwise.</td>
        </tr>
        <tr>
