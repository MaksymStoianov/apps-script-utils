...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td><a href="src/lang/number/requireInteger.ts"><code>requireInteger</code></a> <sup>New</sup></td>
            <td><code>Number</code></td>
            <td>Ensures a value is an integer, throwing <code>IllegalArgumentException</code> otherwise.</td>
        </tr>
        <tr>
