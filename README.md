...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td><a href="src/lang/base/requireNonBoolean.ts"><code>requireNonBoolean</code></a> <sup>New</sup></td>
            <td><code>Any</code></td>
            <td>Ensures a value is <b>not</b> a boolean, throwing <code>IllegalArgumentException</code> otherwise.</td>
        </tr>
        <tr>
