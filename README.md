...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td><a href="src/net/path/requireValidDomain.ts"><code>requireValidDomain</code></a> <sup>New</sup></td>
            <td><code>String</code></td>
            <td>Ensures a value is a valid domain name, throwing otherwise.</td>
        </tr>
        <tr>
