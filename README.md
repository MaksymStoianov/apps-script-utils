...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td><a href="src/lang/string/requireValidLocale.ts"><code>requireValidLocale</code></a> <sup>New</sup></td>
            <td><code>String</code></td>
            <td>Ensures a string is a valid locale code, throwing otherwise.</td>
        </tr>
        <tr>
