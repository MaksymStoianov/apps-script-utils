...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td><a href="src/appsscript/sheet/requireValidSheetName.ts"><code>requireValidSheetName</code></a> <sup>New</sup></td>
            <td><code>String</code></td>
            <td>Ensures a value is a valid sheet name, throwing otherwise.</td>
        </tr>
        <tr>
