...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td><a href="src/lang/base/requireNonArray.ts"><code>requireNonArray</code></a> <sup>New</sup></td>
            <td><code>Any</code></td>
            <td>Ensures a value is <b>not</b> an <code>Array</code>, throwing <code>IllegalArgumentException</code> otherwise.</td>
        </tr>
        <tr>
