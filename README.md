...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td><a href="src/lang/base/requireBoolean.ts"><code>requireBoolean</code></a> <sup>New</sup></td>
            <td><code>Boolean</code></td>
            <td>Ensures a value is a boolean, throwing <code>IllegalArgumentException</code> otherwise.</td>
        </tr>
        <tr>
