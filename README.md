...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td><a href="src/lang/string/nonValidEmail.ts"><code>nonValidEmail</code></a> <sup>New</sup></td>
            <td><code>Boolean</code></td>
            <td>Validates if a string is <b>not</b> a properly formatted email address.</td>
        </tr>
        <tr>
