...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td><a href="src/lang/base/requireNonObjectLike.ts"><code>requireNonObjectLike</code></a> <sup>New</sup></td>
            <td><code>Any</code></td>
            <td>Ensures a value is <b>not</b> object-like (functions included), throwing <code>IllegalArgumentException</code> otherwise.</td>
        </tr>
        <tr>
