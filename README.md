...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td><a href="src/appsscript/sheet/nonGridRangeSameDimensions.ts"><code>nonGridRangeSameDimensions</code></a> <sup>New</sup></td>
            <td><code>Boolean</code></td>
            <td>Checks if two grid ranges do <b>not</b> have the same dimensions.</td>
        </tr>
        <tr>
