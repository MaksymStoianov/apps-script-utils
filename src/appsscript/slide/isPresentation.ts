...
export function isPresentation(
  value: unknown
): value is GoogleAppsScript.Slides.Presentation {
  return (
    typeof value === "object" &&
    value !== null &&
    typeof (value as GoogleAppsScript.Slides.Presentation).getId ===
      "function" &&
    typeof (value as GoogleAppsScript.Slides.Presentation).getSlides ===
      "function"
  );
}
