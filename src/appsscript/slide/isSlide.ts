...
export function isSlide(
  value: unknown
): value is GoogleAppsScript.Slides.Slide {
  return (
    typeof value === "object" &&
    value !== null &&
    typeof (value as GoogleAppsScript.Slides.Slide).getObjectId ===
      "function" &&
    typeof (value as GoogleAppsScript.Slides.Slide).getPageElementById ===
      "function"
  );
}
